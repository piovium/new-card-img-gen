...
export const COST_READONLY_ENTITIES = [
  ...
  116112, // 希诺宁
  300008, 300009, // 沙中遗事
  302220, 302221, 302222, 302223, 302224, 302225, 302226, 302227, 302228, 302229, 302230, 302231, // 乐平波琳
  333021, 333022, 333023, 333024, 333025, 333026, // 奇瑰之汤
];
